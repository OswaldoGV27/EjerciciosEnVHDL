...
ARCHITECTURE DSMB of decodificador_3_a_8 is

	signal jed_node1	: std_logic:='0' ; -- habilitacion
	signal jed_node2	: std_logic:='0' ; -- entrada(2)
...
--Attribute PIN_NUMBERS of habilitacion:SIGNAL is "0001";

SIGNAL  jed_oept_2:std_logic:='0';
--Attribute PIN_NUMBERS of entrada(2):SIGNAL is "0002";
...
--Attribute PIN_NUMBERS of salida(7):SIGNAL is "0014";

SIGNAL  jed_oept_15:std_logic:='0';
SIGNAL  jed_sum_15,jed_fb_15:std_logic:='0';
--Attribute PIN_NUMBERS of salida(5):SIGNAL is "0015";
...
--Attribute PIN_NUMBERS of salida(0):SIGNAL is "0020";
...
--Attribute PIN_NUMBERS of salida(4):SIGNAL is "0022";

SIGNAL  jed_oept_23:std_logic:='0';
SIGNAL  jed_sum_23,jed_fb_23:std_logic:='0';
--Attribute PIN_NUMBERS of salida(6):SIGNAL is "0023";
...
jed_sum_15<= ((not(jed_node1) and not(jed_node2) and (jed_node3) and not(jed_node4)
));
...
jed_sum_21<= ((not(jed_node1) and (jed_node2) and not(jed_node3) and (jed_node4)
));

jed_oept_22<=(one);

jed_sum_22<= ((not(jed_node1) and not(jed_node2) and (jed_node3) and (jed_node4)
));
